...
import { Users, Wallet, ClipboardCheck, GraduationCap, UserPlus, FileText } from "lucide-react";
...
function Dashboard() {
  const { data: stats } = useQuery({
    ...
    queryFn: async () => {
      ...
      const [studentsRes, feesRes, todayAtt, recentStudents] = await Promise.all([
  ...
  const kpis = [
    ...
    { label: "Total Staff", value: 0, icon: GraduationCap, hint: "Add staff module" },
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Overview of your school today.</p>
      </div>
